# lab4
Laboratory work #4, Web application development, 3rd semester
...
Уровень front-end должен быть построен на ReactJS + Redux (необходимо использовать ES6 и JSX) с использованием набора компонентов PrimeReact
...
"Планшетный" - для устройств, ширина экрана которых равна или превышает 855, но меньше 1264 пикселей.
