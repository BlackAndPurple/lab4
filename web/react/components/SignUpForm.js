...
class SignUpForm extends React.Component{
    ...
    render(){
        ...
        return(
            ...
            <form method="post" action="sign_up" onSubmit={this.handleSubmit}>
                <h1>Sign up</h1><br/>
                <span className="input"></span>
                <input type="text" name="login" placeholder="Username" id={loginId} value={this.state.login} onChange={this.onLoginChange} required/>
